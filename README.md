...
| -------------- | ------------- | -----------------------------------|
| `prometheus_version` | 2.15.1 | Prometheus package version. Also accepts `latest` as parameter. Only prometheus 2.x is supported |
...
| `prometheus_basic_auth_password_files` | [] | List of password files for basic auth authentication |
